...
export default class Application {
	...
	private currentlyConstructedActivity?: CustomElementConstructor
	...
	public startActivityWithoutRouting(activityClass: CustomElementConstructor, args?: {[key: string]: string}) {
	...
	public registerErrorActivity(activityClass: CustomElementConstructor) {
	...
	private notFoundActivity?: CustomElementConstructor

	public registerNotFoundActivity(activity: CustomElementConstructor) {
	...
	private registerComponent(component: CustomElementConstructor, forceName?: string, failSilently?: true): string {
	...
	private routes: {[route: string]: () => CustomElementConstructor} = {}
	...
	public async start(args: {routes: {[route: string]: () => CustomElementConstructor}; componentDefinitions: CustomElementConstructor[]}) {
